...
export default function Signup() {
  function signupAction(prevFormState, formData) {
    //this function is for validation of form inputs
    ...
    if (errors.length > 0) {
      //if length of error is greater than 0 then show errors array
      return {
        errors,
        enteredValues: {
          email,
      ...
      }; //if this block dosn't run then below return {errors: null} will run
    } // {errors: errors} - js short hand ->{errors}

    return { errros: null }; //if no error array present in array then no error shown as array is empty
  }
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultChecked={formState.enteredValues?.acquisitionChanel.includes("friend")}
          />
